...
let
  ...
  hp-admin = fetchFromGitHub {
    owner = "Holo-Host";
    repo = "hp-admin";
    rev = "aacb098f473991c80a2177b6091af06a1df0c9d1";
    sha256 = "1c2x8s8g2w869h14cgm1k11c4kbm5q31mfk1y3099gvmrwzxflxc";
  };

  hp-admin-crypto = fetchFromGitHub {
    owner = "Holo-Host";
    repo = "hp-admin-crypto";
    rev = "89b48b317a77211582ee73fb45d310063f6850ed";
    sha256 = "03w5hwmb5rnxw0bd792l1f449f7n5spxw8n6v6wwp7iczwz37g8j";
  };
