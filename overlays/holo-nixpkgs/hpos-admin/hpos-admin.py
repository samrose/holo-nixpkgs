...
def get_traffic_service_logger_call(instance_id):
    return asyncio.get_event_loop().run_until_complete(hc_call('call', { "instance_id": instance_id ,"zome": "service", "function": "get_traffic", "args": {"filter": "DAY"} }))


@app.route('/hosted_stats', methods=['GET'])
def get_hosted_stats():
